(() => {
  ...
  const fallback = (text) => {
    ...
    if (/co\.lab|colab|brand|business growth|growth system/.test(t)) return 'co.lab is the Last Bench Business & Growth engine for founders, brands and operating teams — covering brand development, business development, growth systems and community-led growth. It is an independent entry point. Open /colab/ to enter the co.lab Growth Operating System experience.';
